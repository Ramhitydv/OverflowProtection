// src/lib.rs
/*
 * Core library for OverflowProtection
 */
...
#[derive(Debug)]
pub struct OverflowProtectionProcessor {
    verbose: bool,
    processed_count: usize,
}

impl OverflowProtectionProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting OverflowProtection processing");
    
    let mut processor = OverflowProtectionProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = OverflowProtectionProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = OverflowProtectionProcessor::new(false);
